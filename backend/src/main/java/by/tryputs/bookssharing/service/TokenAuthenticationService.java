...
import by.tryputs.bookssharing.repository.VerificationTokenRepository;
...
public class TokenAuthenticationService {
    ...
    public void addAuthentication(final HttpServletResponse response, final String email, final String roles) {
        final Long userID = userRepository.getIdByEmail(email);
        final String JWT = encode(email, userID.toString(), roles);
